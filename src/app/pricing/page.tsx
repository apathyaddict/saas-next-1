...
const Page = () => {
  ...
  return (
    <>
      <MaxWithWrapper className="mb-8 mt-12 text-center max-w-5xl">
          ...
          <TooltipProvider>
            {pricingItems.map(({ plan, tagline, quota, features }) => {
              ...
              return (
                ...
                >
                  {plan === "Pro" && (
                    <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-pink-600 to-orange-500 px-3 py-2 text-sm font-medium text-white">
                      Upgrade now
                    </div>
                  )}
                  ...
                  <div className="p-5">
                    ...
                    <p className="my-3 font-display text-6xl font-semibold">
                      ${price}
                    </p>
